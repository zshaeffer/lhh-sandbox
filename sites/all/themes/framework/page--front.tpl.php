...
<script>
  ...
  ga('send', 'pageview');
	...
	<meta name="google-site-verification" content="MP3q96RgAdMbaiFF4vc7V25Lr3qpCju-u5NGJbhfEzk" />
  </header> <!-- /#header -->
  ...
  <section id="content-header">
    ...
    <!-- Carousel -->
    <?php if ($page['frontpage_carousel']): ?>
        <section id="frontpage_carousel_block" class="clearfix">
            <section id="frontpage_carousel">
            <?php print render($page['frontpage_carousel']); ?>
            </section>
        </section>
    <?php endif; ?> 
